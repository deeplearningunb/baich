# Contributing to Baich

We would love for you to contribute to `Baich` and help make it even better than it is
...
Help us keep Baich open and inclusive. Please read and follow our [Code of Conduct][coc].

[coc]: https://github.com/deeplearningunb/baich/blob/main/CODE_OF_CONDUCT.md

## <a name="question"></a> Got a Question or Problem?

Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/) where the questions should be tagged with tag `rnn` or `recurrent neural network`.
...
You can file new issues by selecting from our [new issue templates](https://github.com/deeplearningunb/baich/issues/new) and filling out the issue template.

### <a name="submit-pr"></a> Submitting a Pull Request (PR)

Before you submit your Pull Request (PR) consider the following guidelines:

1. Search [GitHub](https://github.com/deeplearningunb/baich/pulls) for an open or closed PR
...
[coc]: https://github.com/deeplearningunb/baich/code-of-conduct/blob/main/CODE_OF_CONDUCT.md
[dev-doc]: https://github.com/deeplearningunb/baich/code-of-conduct/blob/main/README.md
